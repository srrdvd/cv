            ...
            <?php while ( have_posts() ) : the_post(); ?>
                ...
                <?php if (!$post_protected) { ?>
					...
					<?php if ($post_type == 'post') {
						...
						if ($post_categories_str) { ?><span class="post_categories"><span class="icon-align-<?php if (get_bloginfo('text_direction')=='rtl') {echo 'right';} else {echo 'left';}?>"></span><?php echo $post_categories_str; ?></span><?php }
