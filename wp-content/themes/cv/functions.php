...
function shift_cv_styles() {
	...
	if  (get_bloginfo('text_direction')=='rtl'){wp_enqueue_style( 'dark-theme_rtl', get_template_directory_uri().'/css/dark-theme_rtl.css' );}
	...
	if  (get_bloginfo('text_direction')=='rtl'){wp_enqueue_style( 'responsive_rtl', get_template_directory_uri().'/css/responsive_rtl.css' );}
