...
?>
            <section id="resume" class="section resume_section even">
                ...
                <div class="section_header resume_section_header">
                    <h2 class="section_title resume_section_title"><a href="#"><span class="icon icon-align-<?php if (get_bloginfo('text_direction')=='rtl') {echo 'right';} else {echo 'left';}?>"></span><span class="section_name"><?php echo $resume_title; ?></span></a><span class="section_icon"></span></h2>
                </div>
